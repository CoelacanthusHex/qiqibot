# Origin Author: xyb, Diving_Fish
# Adapter: ZnP, GekkaSaori
import re
import asyncio
import os
import math
...
class DrawBest(object):
    ...
    def draw(self):
        splashLogo = Image.open(self.pic_dir + 'Logo_maimai_UNiVERSE.png').convert('RGBA') # modified
...
flag = False
res, success = loop.run_until_complete(generate(payload = {'qq' : lines[1]}))
if success == 0:
    flag = True
else:
